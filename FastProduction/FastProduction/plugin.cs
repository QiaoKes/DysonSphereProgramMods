...
namespace DSPFastProduction
{
    [BepInPlugin(GUID, NAME, VERSION)]

    public class FastProduction : BaseUnityPlugin
    {
        private const string GUID = "tracing.plugin.fastproduction";
        private const string NAME = "FastProduction";
        ...
        void Start()
        {
            Harmony.CreateAndPatchAll(typeof(FastProduction));
            LogInfo();
            ParameterSetting();
        }
        ...
        void ParameterSetting()
        {
            ...
            storage_multiple = Config.Bind("FastProduction", "storage_multiple", 10, new ConfigDescription("物品堆叠倍率"));
        }
